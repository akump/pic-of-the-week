...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*customClass*/ ctx[2]) + " svelte-170tiv8"));
    			add_location(button, file$4, 7, 0, 127);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, [dirty]) {
    			ctx = new_ctx;
    			if (dirty & /*displayText*/ 1) set_data_dev(t, /*displayText*/ ctx[0]);

    			if (dirty & /*isDisabled*/ 8) {
    				prop_dev(button, "disabled", /*isDisabled*/ ctx[3]);
    			}

    			if (dirty & /*customClass*/ 4 && button_class_value !== (button_class_value = "" + (null_to_empty(/*customClass*/ ctx[2]) + " svelte-170tiv8"))) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["displayText", "handler", "customClass", "isDisabled"];
    	...
    	return [displayText, handler, customClass, isDisabled];
    }
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*displayText*/ ctx[0] === undefined && !("displayText" in props)) {
    			console.warn("<Button> was created without expected prop 'displayText'");
    		}
    		...
    		if (/*customClass*/ ctx[2] === undefined && !("customClass" in props)) {
    			console.warn("<Button> was created without expected prop 'customClass'");
    		}

    		if (/*isDisabled*/ ctx[3] === undefined && !("isDisabled" in props)) {
    			console.warn("<Button> was created without expected prop 'isDisabled'");
    		}
    	}
    ...
    const file$3 = "node_modules/svelte-loading-spinners/dist/Jumper.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 44, 4, 991);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 40, 0, 852);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (1:0) <script>     import Button from "./Button.svelte";     import { Jumper }
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script>     import Button from \\\"./Button.svelte\\\";     import { Jumper }",
    		ctx
    	});
    ...
    function create_then_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*currentWeek*/ ctx[1] > 0) return 0;
    		return 1;
    	}
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*currentWeek*/ ctx[1] < /*currentWeekResponse*/ ctx[2]) return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			a = element("a");
    			t0 = text("Pic of the week #");
    			t1 = text(/*currentWeek*/ ctx[1]);
    			t2 = space();
    			img = element("img");
    			t3 = space();
    			div = element("div");
    			...
    			if_block1.c();
    			attr_dev(a, "href", "/");
    			attr_dev(a, "class", "svelte-1m6e14o");
    			add_location(a, file$2, 61, 12, 1949);
    			attr_dev(h1, "class", "main-header svelte-1m6e14o");
    			add_location(h1, file$2, 60, 8, 1912);
    			if (img.src !== (img_src_value = /*imageRoute*/ ctx[11])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "class", "main-img svelte-1m6e14o");
    			attr_dev(img, "alt", "Pic of the week");
    			add_location(img, file$2, 63, 8, 2018);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "imageNum");
    			attr_dev(input, "name", "imageNum");
    			attr_dev(input, "class", "svelte-1m6e14o");
    			add_location(input, file$2, 85, 35, 2751);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "svelte-1m6e14o");
    			add_location(button, file$2, 91, 20, 2970);
    			attr_dev(label, "for", "imageNum");
    			attr_dev(label, "class", "svelte-1m6e14o");
    			add_location(label, file$2, 84, 16, 2694);
    			attr_dev(form, "class", "svelte-1m6e14o");
    			add_location(form, file$2, 83, 12, 2628);
    			attr_dev(div, "class", "navigation svelte-1m6e14o");
    			add_location(div, file$2, 69, 8, 2162);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*jumpToImageNumber*/ ctx[0]);
    			append_dev(label, t6);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*navigateToImage*/ ctx[6]), false, true, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (!current || dirty & /*currentWeek*/ 2) set_data_dev(t1, /*currentWeek*/ ctx[1]);
    			let previous_block_index = current_block_type_index;
    			current_block_type_index = select_block_type(ctx);
    			...
    			if (dirty & /*jumpToImageNumber*/ 1 && input.value !== /*jumpToImageNumber*/ ctx[0]) {
    				set_input_value(input, /*jumpToImageNumber*/ ctx[0]);
    			}
    ...
    function create_if_block_1(ctx) {
    	...
    	button = new Button({
    			props: {
    				customClass: "previous-button",
    				displayText: "Previous",
    				handler: /*prevButtonHander*/ ctx[4]
    			},
    			$$inline: true
    		});
    ...
    // (95:12) {#if currentWeek < currentWeekResponse}
    function create_if_block(ctx) {
    	...
    	button = new Button({
    			props: {
    				customClass: "next-button",
    				displayText: "Next",
    				handler: /*nextButtonHander*/ ctx[5]
    			},
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(95:12) {#if currentWeek < currentWeekResponse}",
    		ctx
    	});
    ...
    // (56:28)          <div class="grid">             <Jumper size="60" color="#1496bb" unit="px" duration="1s" />         </div>     {:then imageRoute}
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "grid svelte-1m6e14o");
    			add_location(div, file$2, 56, 8, 1774);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(56:28)          <div class=\\\"grid\\\">             <Jumper size=\\\"60\\\" color=\\\"#1496bb\\\" unit=\\\"px\\\" duration=\\\"1s\\\" />         </div>     {:then imageRoute}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	handle_promise(/*getImageRoute*/ ctx[3](), info);

    	const block = {
    		c: function create() {
    			main = element("main");
    			info.block.c();
    			attr_dev(main, "class", "svelte-1m6e14o");
    			add_location(main, file$2, 54, 0, 1730);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const getImageRoute = async function () {
    		...
    		$$invalidate(2, currentWeekResponse = await res.json());
    		await sleep(1250);

    		if (weekQueryParam) {
    			weekQueryParam = Number.parseInt(weekQueryParam);

    			if (!isNaN(weekQueryParam) && weekQueryParam > currentWeekResponse || weekQueryParam < 0) {
    				$$invalidate(1, currentWeek = currentWeekResponse);
    			} else {
    				if (isNaN(weekQueryParam)) {
    					$$invalidate(1, currentWeek = currentWeekResponse);
    				} else {
    					$$invalidate(1, currentWeek = weekQueryParam);
    				}
    			}
    		} else {
    			$$invalidate(1, currentWeek = currentWeekResponse);
    	...
    	function input_input_handler() {
    		jumpToImageNumber = this.value;
    		$$invalidate(0, jumpToImageNumber);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("jumpToImageNumber" in $$props) $$invalidate(0, jumpToImageNumber = $$props.jumpToImageNumber);
    		if ("weekQueryParam" in $$props) weekQueryParam = $$props.weekQueryParam;
    		if ("currentWeek" in $$props) $$invalidate(1, currentWeek = $$props.currentWeek);
    		if ("currentWeekResponse" in $$props) $$invalidate(2, currentWeekResponse = $$props.currentWeekResponse);
    	};
    ...
    /* src/Admin.svelte generated by Svelte v3.38.2 */
    const file$1 = "src/Admin.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 5, 4, 134);
    			attr_dev(input1, "type", "submit");
    			add_location(input1, file$1, 6, 4, 172);
    			attr_dev(form, "action", "/upload");
    			attr_dev(form, "method", "post");
    			attr_dev(form, "enctype", "multipart/form-data");
    			add_location(form, file$1, 4, 0, 62);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Link, Route, Home, Admin, url });
